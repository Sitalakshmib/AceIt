...
async def get_progress_stats(user_id: str):
    ...
    try:
        ...
        for problem in all_problems:
            if problem.tags:
                for tag in (problem.tags if isinstance(problem.tags, list) else [problem.tags]):
        ...
        check_date = today
        while True:
            if check_date.isoformat() in activity_data:
                current_streak += 1
