    ...
    if (view === 'selection') {
        return (
            <div className="p-6 max-w-4xl mx-auto relative">
                ...
                <button
                    onClick={() => navigate('/')}
                    className="absolute top-8 left-0 flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-600 font-bold rounded-xl hover:bg-gray-50 hover:text-blue-600 transition-all shadow-sm group z-40 mb-4"
